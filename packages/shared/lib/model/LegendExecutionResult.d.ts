...
export declare class LegendExecutionResult {
    ids: string[];
    ...
    static readonly serialization: SerializationFactory<LegendExecutionResult>;
}
//# sourceMappingURL=LegendExecutionResult.d.ts.map